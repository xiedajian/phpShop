...
function orderPaymentName($payment_code) {
    return str_replace(
            array('offline','online','alipay','tenpay','chinabank','predeposit','transfer','wxpay','fuiou'),
            array('货到付款','在线付款','支付宝','财付通','网银在线','站内余额支付','线下转账','微信支付','富友支付'),
            $payment_code);
}
...
function orderPayType($goods_pay_type,$sub_type){
    $type = array(
        0=>'',
        1=>array(
            1=>'',
