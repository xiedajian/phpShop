...
<div class="video">
    ...
    <div class="video_detail">
        ...
        <p style="margin: 10px 0;"><span class="geshi">格式：psd</span><span class="geshi">尺寸：4582*546</span><span class="geshi">大小：33.333MB</span></p>
        <ul class="data-panel">
        ...
        <div class="video_btn">
            <a href="orderstart.php" class="liji_buy btn">立即购买</a>
            <a class="privew btn" onclick="divshow()">加入待买课程</a>
        </div>
        <div class="link_pannel">
            <a href=""><img src="../image/store_xing.png">收藏课程</a>
            <a href=""><img src="../image/share.png"> 分享课程</a>
        </div>
        <p>
            提示：购买套餐更便宜，购买套餐后您可以无限量的使用相关素材<a class="blue_color pd_left15" href="">购买套餐</a>
        </p>
    </div>
</div>
...
<!--    <li name="tab_1" class="current1">课程内容</li>-->
    <li name="tab_2" class="current1">评论<em>(0)</em></li>
