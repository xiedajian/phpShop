...
<link href="<?php echo COURSE_RESOURCE_SITE_URL;?>/font/font-awesome/css/font-awesome.min.css" rel="stylesheet" />
<!--[if IE 7]>
...
#faq { display: none;}
.msg { font: 100 36px/48px arial,"microsoft yahei"; color: #555; background-color: #FFF; text-align: center; width: 100%; border-top: solid 1px #E6E6E6;border-bottom:solid 1px #E6E6E6;  margin-bottom: 10px; padding: 120px 0;}
...
<div class="msg">
      ...
      <i class="icon-ok-sign" style=" color: #099;"></i>
        ...
        <a href="JavaScript:history.go(-1);" style="color:#39C;font-size: 25px;">返回上一页</a>
        <?php } ?>
</div>
