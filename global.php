...
define('TPL_COURSE_NAME','default');
define('TPL_CIRCLE_NAME', 'default');
define('TPL_MICROSHOP_NAME', 'default');
define('TPL_CMS_NAME', 'default');
define('TPL_ADMIN_NAME', 'default');
define('UMALL_SITE_URL','http://umall.ipvp.cn');

//sso配置
define('SSO_APP_ID',1);
define('SSO_APP_KEY','asdfghjk12345678asdfghjk12345678asdfghjk12345678asdfghjk12345678asdfghjk12345678asdfghjk12345678asdfghjk12345678asdfghjk12345678');
define('SSO_AUTH_API' ,'http://auth.ipvp.cn/index.php');
define('SSO_CALLBACK','http://www.ipvp.cn/shop/index.php?act=login&op=index');
//sso配置
...
//未付款订单，自动取消的天数
define('ORDER_AUTO_CANCEL_DAY', 7);
//已发货订单，自动确认收货的天数
