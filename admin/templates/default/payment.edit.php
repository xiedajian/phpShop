  ...
  <form id="post_form" method="post" name="form1">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <tr class="noborder">
            <td class="vatop rowform"><input type="hidden" name="config_name" value="fuiou_account,fuiou_key" />
                <input name="fuiou_account" id="fuiou_account" value="<?php echo $output['config_array']['fuiou_account'];?>" class="txt" type="text"></td>
            <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
            <td class="vatop rowform"><input name="fuiou_key" id="fuiou_key" value="<?php echo $output['config_array']['fuiou_key'];?>" class="txt" type="text"></td>
            <td class="vatop tips"></td>
        </tr>
        <?php }else if ($output['payment']['payment_code'] == 'chinabank') { ?>
        <tr>
          <td colspan="2" class="required"><?php echo $lang['payment_chinabank_account'];?>: </td>
        </tr>
        <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="hidden" name="config_name" value="account_name,account_no,account_bank,alipay_account" />
            <input name="account_name" id="account_name" value="<?php echo $output['config_array']['account_name'];?>" class="txt" type="text"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input name="account_no" id="account_no" value="<?php echo $output['config_array']['account_no'];?>" class="txt" type="text"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input name="account_bank" id="account_bank" value="<?php echo $output['config_array']['account_bank'];?>" class="txt" type="text"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input name="alipay_account" id="alipay_account" value="<?php echo $output['config_array']['alipay_account'];?>" class="txt" type="text"></td>
          <td class="vatop tips"></td>
        </tr>
        <?php } ?>
        <tr>
