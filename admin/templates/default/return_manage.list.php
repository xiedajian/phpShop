...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
          <li><a href="index.php?act=return&op=return_manage" class="current"><span><?php echo '待处理';?></span></a></li>
  ...
  <table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="bd-line" >
        ...
        <td class="align-center"><?php if($val['refund_state']==2){?><a href="index.php?act=return&op=edit&return_id=<?php echo $val['refund_id']; ?>"> 确认 </a><?php } ?></td>
      </tr>
      <?php } ?>
    </tbody>
    <?php } else { ?>
