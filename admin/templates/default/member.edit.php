  ...
  <form id="user_form" enctype="multipart/form-data" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
            <td class="vatop rowform onoff"><label for="vip" class="cb-enable <?php if($output['member_array']['member_level'] == '2'){ ?>selected<?php } ?>" ><span>VIP会员</span></label>
                <label for="normal" class="cb-disable <?php if($output['member_array']['member_level'] == '1'){ ?>selected<?php } ?>" ><span>普通会员</span></label>
                <input id="normal" name="member_level" <?php if($output['member_array']['member_level'] == '1'){ ?>checked="checked"<?php } ?>  value="1" type="radio">
                <input id="vip" name="member_level" <?php if($output['member_array']['member_level'] == '2'){ ?>checked="checked"<?php } ?> value="2" type="radio"></td>
            <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" class="required"><label>测试会员:</label></td>
        </tr>
        <tr class="noborder">
            <td class="vatop rowform onoff">
                <label for="is_test_1" class="cb-enable <?php if($output['member_array']['is_test'] == '1'){ ?>selected<?php } ?>" ><span>是</span></label>
                <label for="is_test_2" class="cb-disable <?php if($output['member_array']['is_test'] != '1'){ ?>selected<?php } ?>" ><span>否</span></label>
                <input id="is_test_1" name="is_test" <?php if($output['member_array']['is_test'] == '1'){ ?>checked="checked"<?php } ?>  value="1" type="radio">
                <input id="is_test_2" name="is_test" <?php if($output['member_array']['is_test'] != '1'){ ?>checked="checked"<?php } ?> value="0" type="radio"></td>
            <td class="vatop tips"></td>
        </tr>
          ...
          <tr>
              <td colspan="2">
                  <table style="width: 80%">
                      ...
                      <?php foreach($output['address_info'] as $address){
                              if($address['tel_phone']&&$address['mob_phone'])$tel=$address['tel_phone'].'/'.$address['mob_phone'];
                              else $tel = ($address['tel_phone']?$address['tel_phone']:$address['mob_phone']);
                              ?>
                          <tr>
