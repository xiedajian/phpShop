...
<div class="page">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <tr class="noborder">
                ...
                <input type='radio' value='1' checked="checked"  name='type'>图文
                <input type='radio' value='2' name='type'>视频
                <input type='radio' value='3' name='type'>图片
                </td>
         </tr> 
         <tr class="noborder">
                    <td colspan="2" class=""><label class="" for="title">精品课程:</label>
                    <input type="checkbox" value='1' name='is_jp'>精品课程</td>
         ...
         <tr class="noborder">
          ...
          <tr class="noborder">
                ...
                <tr class="noborder">
                    <td class="vatop rowform">
                        <textarea  value="0" name="remark" rows="5" cols="200" style="width:500px; height:100px;"></textarea>
                    </td>              
          </tr>
           <tr>
          ...
          <tr class="noborder">
                    ...
                    <div style="width: 500px;" id="tag">
                       <?php if(!empty($output['tag']) && is_array($output['tag'])){ ?>
	                       ...
	                       <input type="checkbox" value='<?php echo $list['id']; ?>' name='tag[]' class='tag'><?php echo $list['name']; ?>
	                       </div>
	                       <?php } ?>
                       <?php } ?>
                       </div>
		  ...
		  <tr class="noborder">
          	...
          	<textarea class="text-input " id="content" name="content" cols="79" rows="15" style="width:750px;height:300px;"></textarea>
         ...
         <tr class="noborder">
              ...
              <input type="checkbox" value='1' name='is_down' id="is_down">包含下载</td>
         </tr> 
         
         <tr class="noborder">
         			 <td colspan="3" id="down_td"><input type="file" multiple="multiple" id="download" name="download_add" />
         			<span id='add_download'></span>
         			 </td>
      	</tr> 
         
         <tr class="noborder">
                    <td colspan="2" class="required"><label class="" for="browse">浏览权限:</label>
                    <input type="checkbox" value='1' name='browse[]'>经销商(注册认证会员)
                    <input type="checkbox" value='2' name='browse[]'>分销商
                    <input type="checkbox" value='4' name='browse[]'>公众/游客</td>
                    
         </tr> 
          
          <tr class="noborder">
                <td colspan="2" class="required"><lable class="" for="type">分享类型（微信朋友圈）：</lable> 
                <input type='radio' value='1' checked="checked"  name='share'>自动提取文章标题和图片;不包含官网链接
                <input type='radio' value='2' name='share'>普通文章分享(文章带官网链接) 
                </td>
         </tr> 
  ...
  <br/>
   <br/>
 		 <tr class="noborder">
              <td colspan="2" class="required">
              <input type="checkbox" value='1' name='pay' id="pay">需要付费</td>
         </tr> 
         ...
         <tr class="pay"  style="display:none;">
         	<td>促销价（元）：<input type="text" value="" name="promotion_price" class="txt">
         	促销结束时间：<input type="text" value="" name="promotion_time" class="txt date" id='payment_time_start'>
         	促销词：<input type="text" value="" name="promotion_data" class="txt">
         	</td>
         ...
         <td>购买后可以执行的操作：
          <select name="operation" id="level_1">
             <option value="1">在线观看</option>
             <option value="2">下载</option>
             <option value="3">直接应用到微店</option>
         </select>
         ...
         <tr class="noborder">
              ...
              <input type="checkbox" value='1' name='in_package' id="pay">是否在套餐内</td>
         </tr>  
      </tbody>
      <tfoot>
        <tr class="tfoot">
