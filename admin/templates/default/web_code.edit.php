              ...
              <td>
            	 <table class="table tb-type2">
                  ...
                  <tfoot>
                    <tr class="tfoot">
                      <td colspan="15" >
                          <a href="JavaScript:void(0);" onclick="$('#recommend_pic_form').submit();" class="btn"><span><?php echo $lang['web_config_save'];?></span></a>
                          <span class="save-tip" style="display: none;color: green">保存成功！请记得更新板块内容</span>
                      </td>
                    </tr>
                  </tfoot>
                </table>
