...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?act=refund&op=refund_manage" class="current"><span><?php echo '待处理';?></span></a></li>
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    ...
    <input type="hidden" name="wait_confirm" value="<?php echo $_GET['wait_confirm'];?>" />
  ...
  <table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="bd-line" >
        ...
        <td class="align-center"><?php if($val['seller_time'])echo date('Y-m-d H:i:s',$val['seller_time']);else echo '待商家审核'; ?></td>
        <td class="align-center"><?php echo $val['refund_amount'];?></td>
        <td class="align-center"><?php if($val['refund_state']==2){?><a href="index.php?act=refund&op=edit&refund_id=<?php echo $val['refund_id']; ?>"> 确认 </a><?php } ?></td>
      </tr>
      <?php } ?>
    </tbody>
    <?php } else { ?>
