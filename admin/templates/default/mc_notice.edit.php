            ...
            <tbody>
                ...
                <tr class="noborder">
                    <td class="vatop rowform">
                        <input type="text" value="<?php echo $output['val']['content'];?>" name="content" class="txt" required>
                    </td>
                ...
                <tr class="noborder">
                    <td class="vatop rowform">
                        <input type="text" id="onshelf_time" value="<?php echo date('Y-m-d H:i:s',$v['onshelf_time']); ?>" name="onshelf_time" class="txt date " readonly="readonly" required>
                    <td class="vatop tips"></td>
                </tr>
                <tr>
                ...
                <tr class="noborder">
                    <td class="vatop rowform">
                        <input type="text" id="offshelf_time"  value="<?php echo date('Y-m-d H:i:s',$v['offshelf_time']); ?>" name="offshelf_time" class="txt date " readonly="readonly" required>
