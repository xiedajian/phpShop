...
$arr = array(
		...
		'left' =>array(
			...
			3 => array(
				...
				'text' => '供应商',
				'list' => array(
					array('args'=>'store,store,store',						'text'=>'供应商管理'),
					array('args'=>'store_grade,store_grade,store',			'text'=>'供应商等级'),
					array('args'=>'store_class,store_class,store',			'text'=>'供应商分类'),
					array('args'=>'store_domain_setting,domain,store',		'text'=>$lang['nc_domain_manage']),
					array('args'=>'stracelist,sns_strace,store',			'text'=>'供应商动态'),
					array('args'=>'help_store,help_store,store',			'text'=>'供应商帮助'),
					array('args'=>'edit_info,store_joinin,store',			'text'=>'开店首页'),
					array('args'=>'list,ownshop,store',						'text'=>'自营供应商'),
				)
			),
			4 => array(
				'nav' => 'member',
				...
				'list' => array(
				    ...
				    array('args'=>'index,member_org,member',					'text'=>'店铺认证'),
			...
			6 => array(
				...
				'list' => array(
					...
					array('args'=>'index,material,website',			'text'=>'素材管理'),
				)
			),
			7 => array(
				'nav' => 'operation',
			...
			8 => array(
				...
				'list' => array(
					...
					array('args'=>'newstore,stat_store,stat',			'text'=>'供应商统计'),
            ...
            9 => array(
                ...
                'text' => $lang['nc_course'],
                'list' => array(
                    array('args'=>'index,mc_menu,course',			         'text'=>'首页导航栏'),
                    array('args'=>'index,mc_block,course',			'text'=>'版块管理'),
                    array('args'=>'index,mc_category,course',			'text'=>'分类管理'),
                    array('args'=>'newstore,mc_material,course',			'text'=>'内容管理'),
                    array('args'=>'income,mc_content,course',				'text'=>'系统公告'),
                	array('args'=>'index,mc_tag,course',                    'text'=>'标签管理'),
                )
            ),
		),
);
