...
$_limit =  array(
	...
	array('name'=>$lang['nc_member'], 'child'=>array(
		...
		array('name'=>'店铺管理', 'op'=>null, 'act'=>'member_org'),
	...
	array('name'=>$lang['nc_website'], 'child'=>array(
		...
		array('name'=>'素材管理', 'op'=>null, 'act'=>'material'),
		)),
	...
	array('name'=>'微营销课堂', 'child'=>array(
		array('name'=>'首页导航栏', 'op'=>null, 'act'=>'mc_menu'),
		array('name'=>'版块管理', 'op'=>null, 'act'=>'mc_block'),
		array('name'=>'分类管理', 'op'=>null, 'act'=>'mc_category'),
		array('name'=>'内容管理', 'op'=>null, 'act'=>'mc_material'),
		array('name'=>'系统公告', 'op'=>null, 'act'=>'mc_notice'),
	)),
);
