               ...
               // var_dump($gc_list[$value[0]]['class2'][$value[1]].'11');
                if (!empty($gc_list[$value[0]]['class2'][$value[1]])) { // 二级
                    ...
                    if (!empty($gc_list[$value[0]]['class2'][$value[1]]['class3'][$value[2]])) {    // 三级
                    	...
                    	if($gc_list[$value[0]]['class2'][$value[1]]['class3'][$value[2]]['gc_states']==1){
