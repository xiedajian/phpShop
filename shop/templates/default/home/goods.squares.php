...
<?php require_once 'goods_spec.dialog.php';?>
      ...
      <div class="goods-content" nctype_goods="<?php echo $value['goods_id'];?>" nctype_store="<?php echo $value['store_id'];?>">
        ...
        <div class="goods-info">
          ...
          <div class="goods-price">
              ...
              <?php }else{?>
                  <span style="color: #999;float: left"><?php echo $output['show_price']['show_price_short_tip'];?></span>
              <?php }?>
          ...
          <div class="add-cart">
            ...
            <?php } else {?>
            <a href="javascript:void(0);" <?php if($_SESSION['is_login']==1&&!empty($_SESSION['org_id'])){ ?>onclick="show_goods_spec_dialog(<?php echo $value['goods_commonid'];?>);"<?php }else{?>style="cursor: not-allowed;" <?php }?>><i class="icon-shopping-cart"></i>加入进货单</a>
            <?php }?>
            <?php }?>
          </div>
        </div>
