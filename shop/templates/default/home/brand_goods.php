    ...
    <div class="nch-module nch-module-style03">
      ...
      <div class="content">
        <div class="nch-sidebar-viewed" id="nchSidebarViewed">
          <ul>
          <?php if(!empty($output['viewed_goods'])){ echo 'rewtew'; ?>
            ...
            <li>
              ...
              <dl>
                ...
                <dd><?php echo $lang['currency'];?><?php echo $v['goods_promotion_price']; ?><?php if($v['goods_state']=='0')?><span style="margin-left: 10px;color:red">已下架</span></dd>
              </dl>
            </li>
            <?php } ?>
          <?php } ?>
