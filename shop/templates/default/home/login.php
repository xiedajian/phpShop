...
<div class="nc-login-layout">
  ...
  <div class="nc-login">
    ...
    <div class="nc-login-content" id="demo-form-site">
      <form id="login_form" method="post" action="<?php echo $output['action'];?>"  class="bg">
      ...
      <dl class="mt10 mb10">
        <dt>&nbsp;</dt>
        <dd><?php echo $lang['login_index_regist_now_1'];?><a title="" href="index.php?act=login&op=ipvp_register" class="register"><?php echo $lang['login_index_regist_now_2'];?></a></dd>
      </dl>
