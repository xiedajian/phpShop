...
<div class="header-wrap">
  <header class="public-head-layout wrapper">
   ...
   <?php if (C('mobile_isuse') && C('mobile_app')){?>
    ...
    <?php } ?>
    -->
    <div style="margin-left:60px;" id="search" class="head-search-bar">
	<!--商品和店铺-->
      <!--<ul class="tab">
    ...
    <div class="head-user-menu">
        <dl class="my-shop">
            <dt><span class="ico"></span>我的微店铺<i class="arrow"></i></dt>
            <dd>
                <div class="sub-title">
                    <h4><?php echo $_SESSION['member_name'];?>
                        <?php if ($output['member_info']['level_name']){ ?>
                            <div class="nc-grade-mini" style="cursor:pointer;"><?php echo $output['member_info']['level_name'];?></div>
                        <?php } ?>
                    </h4>
                    <a target="_blank" href="<?php echo UMALL_SITE_URL; ?>/user.php?c=store&a=index" class="arrow">我的微店铺管理中心<i></i></a></div>
                <div class="user-centent-menu">
                    <ul>
                        <li><a target="_blank" href="<?php echo UMALL_SITE_URL; ?>/user.php?c=fx&a=market">拼单网分销商品</a></li>
                        <li><a target="_blank" href="<?php echo UMALL_SITE_URL; ?>/user.php?c=trade&a=income">收入/提现</a></li>
                        <li><a target="_blank" href="<?php echo UMALL_SITE_URL; ?>/user.php?c=goods&a=index">出售中的商品</a></li>
                        <li><a target="_blank" href="<?php echo UMALL_SITE_URL; ?>/user.php?c=store&a=index" >店铺管理</a></li>
        ...
        <?php } ?>
        <dt><span class="ico"></span>进货单<i class="arrow"></i></dt>
        <dd>
          <div class="sub-title">
            <h4>最新加入的商品</h4><F12>
          </div>
          ...
          <div class="checkout"> <span class="total-price">共<i><?php echo $output['cart_goods_num'];?></i><?php echo $lang['nc_kindof_goods'];?></span><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=cart" class="btn-cart">结算进货单中的商品</a> </div>
        </dd>
      </dl>
    </div>
  </header>
    ...
    <ul class="site-menu">
     ...
     <!-- <?php if (C('groupbuy_allow')){ ?>
      ...
      <li><a
        ...
        if($nav['nav_title']=='直邮宝'){
        	echo ' style="color:yellow"';
        }
        if($nav['nav_title']=='会员宝'){
            echo ' class="hyb"';
        }


        ?>><?php echo $nav['nav_title'];?></a>
<!--                  modified by wdj, adding '会员宝' with 'new-tab';-->
                  <?php
                  if($nav['nav_type'] == '4')
                      echo  '<span class="new-tab"></span>';
                  ?>
      </li>
      <?php }?>
      <?php }?>
