 ...
 <div id="faq">
  <div class="faq-wrapper">
   ...
   <div style='width:70%;float:left;'>
    <div style="font-size:18px;padding-left:10px;">合作伙伴</div> 
    <ul>
      <?php for($i=0;$i<=13;$i++){ ?>
      <li style="padding:10px 5px; width:110px;" >
        <span style="background-color:#FFF;border:1px solid #CCC;padding:5px 11px;display:block;">
        <img width="88" height="40" src='<?php echo SHOP_TEMPLATES_URL.'/images/business/b_'.$i.'.jpg';?>'</li>
        </span>
      <?php } ?>
    </ul>
   </div>
<div class="help" style='float:right;margin-top:25px;'>
