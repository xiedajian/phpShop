...
<div class="ncm-oredr-show">
  ...
  <div class="ncm-order-contnet">
    <table class="ncm-default-table order">
      <thead>
      <?php if($output['order_info']['take_apart']){?>
      <tr><td colspan="20" style="background-color: #FEFDDC">&nbsp;&nbsp;本单已拆单处理，<a href="index.php?act=member_order&op=show_sub_order&order_id=<?php echo $output['order_info']['order_id'];?>">请查看子单</a></td></tr>
      <?php }?>
        <tr>
          <th class="w10"></th>
