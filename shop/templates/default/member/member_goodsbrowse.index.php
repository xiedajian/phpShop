          ...
          <div class="browse-goods">
            ...
            <dl class="goods-info">
              ...
              <em class="market-price" title="市场价"><?php echo $lang['currency'];?><?php echo $v['goods_marketprice'];?></em>
                  <?php if($v['goods_state']=='0') { ?><span style="margin-left: 10px;color:red">已下架 <?php }?>

              </dd>
            </dl>
           <!-- <a class="ncm-btn ncm-btn-orange" href="javascript:addcart(<?php echo $v['goods_id'];?>,1,'');"><i class="icon-shopping-cart"></i>加入进货单</a>
            <br/><br/>-->
