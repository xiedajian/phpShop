    ...
    <tbody>
      ...
      <tr>
        <th colspan="20"> <span class="ml10"><?php echo $lang['refund_order_refundsn'].$lang['nc_colon'];?><?php echo $val['refund_sn']; ?></span><span><?php echo $lang['refund_buyer_add_time'].$lang['nc_colon'];?><?php echo date("Y-m-d H:i:s",$val['add_time']);?></span>
          ...
          <!-- store_name -->
          <span>
           <!-- <a href="<?php echo urlShop('show_store','index',array('store_id'=> $val['store_id']), $output['store_list'][$val['store_id']]['store_domain']);?>" target="_blank" title="<?php echo $order_info['store_name'];?>"><?php echo $val['store_name']; ?></a>-->
