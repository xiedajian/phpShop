    ...
    <tbody order_id="" <?php if (!empty($group_info['pay_amount']) && $p == 0) {?> class="pay" <?php }?>>
      ...
      <tr>
        <th colspan="19"> <span class="ml10">
          ...
          <!-- store_name -->
          <span><!--<a href="<?php echo urlShop('show_store','index',array('store_id'=>$order_info['store_id']), $order_info['extend_store']['store_domain']);?>" title="<?php echo $order_info['store_name'];?>"><?php echo $order_info['store_name']; ?></a>-->
      ...
      <tr>
        ...
        <td class="tl"><dl class="goods-name">
            ...
            <dd>
                ...
                <span class="sale-type"><?php echo $goods_info['goods_type_cn'];?></span>
                <?php } ?>
