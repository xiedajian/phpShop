    ...
    <div class="outline">
      <div class="user-account">
        <ul>
          ...
          <li id="voucher"><a href="index.php?act=member_message&op=message" title="查看我的消息">
            <h5>站内消息</h5>
            <span class="icon"></span> <span class="value"><em><?php echo $output['message_num']>0?$output['message_num']:0;?></em></span></a> </li>
          <li id="points"><a href="index.php?act=member_favorites&op=fglist" title="查看我的收藏">
            <h5>我的收藏</h5>
            <span class="icon"></span> <span class="value"><em><?php echo $output['home_member_info']['favorites_count'];?></em></span></a> </li>
        </ul>
      </div>
    </div>
  </div>
