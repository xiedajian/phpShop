...
<div class="ncsc-flow-layout">
  <div class="ncsc-flow-container">
    <div class="title">
      ...
      <div style="padding: 5px 0px;border:1px solid #dddddd;width: 100px;text-align: center;cursor: pointer;margin: 10px 0px" onclick="history.back()">返回</div>
      <?php if(!$output['is_sub_order']){?>
  ...
  <div class="ncsc-flow-item">
    ...
    <div class="item-order" <?php if($output['is_sub_order'])echo 'style="display:none"';?>>
      <dl>
        <dt>运费：</dt>
...
$(function(){
    ...
    <?php if($output['is_sub_order']){?>
    var_send = '<li><?php echo date("Y-m-d H:i:s",$output['sub_order']['send_time']); ?>&nbsp;&nbsp;<?php echo $lang['member_show_seller_has_send'];?></li>';
    <?php }else{?>
