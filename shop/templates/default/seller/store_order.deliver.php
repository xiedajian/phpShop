        ...
        <dl>
          ...
          <dd>
            ...
            <?php if ($order['order_state'] == ORDER_STATE_PAY) {?>
                    <?php if ($output['take_apart']) {?>
            <span><a style="margin-left: 20px;" href="index.php?act=store_deliver&op=take_apart&order_id=<?php echo $order['order_id'];?>" class="ncsc-btn-mini ncsc-btn-acidblue fr">我要拆单</a></span>
                        <?php }?>
