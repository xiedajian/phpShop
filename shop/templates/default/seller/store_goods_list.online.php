  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="nscs-table-handle"><?php if ($val['goods_lock'] == 0) {?>
        ...
        <?php }?>
         <?php if($val["is_onlybuy"]){?>
           <span><a href="<?php echo urlShop("store_goods_online","onlybuy_power",array('commonid' => $val['goods_commonid']));?>"  class="btn-blue"><i class="icon-user"></i>
            <p>独家经销权</p>
           </a></span>
         <?php } ?>
        </td>
