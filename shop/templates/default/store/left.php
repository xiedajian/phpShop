  ...
  <div class="content">
    <ul class="ncs-top-tab pngFix">
      <li id="hot_sales_tab" class="current">
          <a href="javascript:void(0);"><?php echo $lang['nc_hot_goods_rankings'];?></a></li>
      <li id="hot_collect_tab"><a href="javascript:void(0)"><?php echo $lang['nc_hot_collect_rankings'];?></a></li>
    </ul>
      ...
      <ol>
        ...
        <li>
          <dl>
            ...
            <dd class="price pngFix"><?php if($output['show_price']) echo $val['goods_price'];?>&nbsp;&nbsp;(<?php echo $val['spec_count']?>种规格)</dd>
            <dd class="selled pngFix"><?php echo $lang['nc_sell_out'];?><strong><?php echo $val['num'];?></strong><?php echo $lang['nc_bi'];?></dd>
          </dl>
        </li>
        <?php }?>
      </ol>
      ...
      <ol>
        ...
        <li>
          <dl>
            ...
            <dd class="price pngFix"><?php if($output['show_price'])echo $val['goods_price']?>&nbsp;&nbsp;(<?php echo $val['spec_count']?>种规格)</dd>
            <dd class="collection pngFix"><?php echo $lang['nc_collection_popularity'].$lang['nc_colon'];?><strong><?php echo $val['num'];?></strong></dd>
          </dl>
        </li>
        <?php }?>
      </ol>
