...
//友情链接
        ...
        $xianshi_item = $model_xianshi_goods->getXianshiGoodsCommendList(5);
		...
		Model('seo')->type('index')->show();
                ...
                if($_SESSION['member_id']){
                 ...
                 $member_info['favorites_count']=Model('favorites')->getMemberGoodsFavoritesCount($_SESSION['member_id']);
        ...
        if(!$_SESSION['member_id']){
            Tpl::output('action',sync_login(SSO_CALLBACK."&ref_url=".'http://'.$_SERVER['HTTP_HOST']));
        }
		Tpl::showpage('index');
	}
